...
const formsubmit = () => {
    eventform.post(route("contact.reg"));
};
</script>
...
<section class="bish-bg">
    ...
    <div class="flex flex-col mb-5 sm:text-center sm:mb-0">
        ...
        <h2 class="font-bold  text-gray-900 sm:text-4xl md:mx-auto">
          ...
          <span class="text-red-700 text-5xl">\\\</span> <span class="text-white text-5xl">Contact</span>
        </h2>
...
<section class="bg-gray-50 ">
    <div class="flex grid justify-center lg:px-40 lg:py-16 p-6">
    <p class="text-center lg:px-16 font-bold">    
        We are so happy that you took the time to stop by our website.

        Always remember that we are here to serve you.  If you are in need of ministry services, business consultation, 

        want to find out more about our list of companies, or just in need of counseling,

        feel free to reach us by filling out the contact form below.
    </p>
    <p class=" text-center lg:px-16 font-bold py-4">
        We would love to meet you and be of assistance.
    </p>    
    </div>
    ...
    <select id="countries" class="block py-2.5 px-3 w-full text-sm text-gray-900 bg-white border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="eventform.activity"   required>
        <option value="" disabled>Reasons for contacting us?</option>
        <option value="Counseling">Counseling</option>
        <option value="Prayer">Prayer</option>
        <option value="Business Consultation/Coaching">Business Consultation/Coaching</option>
        <option value="Ministry">Ministry</option>
        <option value=">Invite Bishop as a Guest Speaker">Invite Bishop as a Guest Speaker</option>
        <option value="International Kingdom Church">International Kingdom Church</option>
        <option value="Kingdom Global Fellowship">Kingdom Global Fellowship</option>
    </select> 
    </div>
    ...
    <select id="countries" class="block py-2.5 px-3 w-full text-sm text-gray-900 bg-white border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="eventform.mode"   required>
        <option value="" disabled >Best ways to reach out to you</option>
        <option value="Email">Email</option>
        <option value="Phone Call">Phone Call</option>
        <option value="In Person Visit to our Office">In Person Visit to our Office</option>
